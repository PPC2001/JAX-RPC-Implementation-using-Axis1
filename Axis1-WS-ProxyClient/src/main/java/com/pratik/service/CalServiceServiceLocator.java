...
public class CalServiceServiceLocator extends org.apache.axis.client.Service implements com.pratik.service.CalServiceService {
    ...
    private java.lang.String CalService_address = "http://localhost:8080/Axis1-WS/services/CalService";
    ...
    public com.pratik.service.CalService getCalService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.pratik.service.CalServiceSoapBindingStub _stub = new com.pratik.service.CalServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.pratik.service.CalService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.pratik.service.CalServiceSoapBindingStub _stub = new com.pratik.service.CalServiceSoapBindingStub(new java.net.URL(CalService_address), this);
                _stub.setPortName(getCalServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://service.pratik.com", "CalServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://service.pratik.com", "CalService"));
        }
